...
namespace messanger.Server.Repositories.Implementations
{
    public class ConversationsRepository : IConversationsRepository
    {
        ...
        public async Task<IEnumerable<ConversationResponseDto>> GetUserRecentConversationsAsync(string idUser, int skip)
        {
        ...
        public async Task<IEnumerable<ConversationResponseDto>> GetUserConversationsMatchingFilterAsync(string idUser, string filter)
        {
            const int takeConversations = 10;
            const int takeConversationMembers = 5;
